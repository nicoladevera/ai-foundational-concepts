...
- GPT-5.2 / GPT-5.1: Parameter counts not publicly disclosed
...
- **Example:** Claude Opus 4.6 has a 1 million token context window (roughly 750,000 words), GPT-5.2 has 400,000 tokens, Gemini 3 Flash/Pro have 1 million tokens
...
- **GPT-4:** ~1.7 trillion parameters
- **Latest models (GPT-5.2, GPT-5.1, Claude Opus 4.5, Gemini 3 Pro):** Parameter counts not publicly disclosed
